...
export interface IStateHandler extends RuleDatagridStateHandler, SidebarStateHandler, ModalStateHandler, SettingStateHandler, DataSrcStateHandler, ViewStateHandler {}